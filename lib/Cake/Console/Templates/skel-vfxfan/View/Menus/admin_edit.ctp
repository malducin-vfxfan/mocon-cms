...
<div class="row">
	<section class="admin-actions">
		...
		<ul class="action-buttons-list">
			<li><?php echo $this->Form->postLink('Delete', array('action' => 'admin_delete', $this->Form->value('Menu.id')), array('class' => 'btn danger'), sprintf('Are you sure you want to delete # %s?', $this->Form->value('Menu.id'))); ?></li>
		...
		<?php echo $this->Form->create('Menu', array('class' => 'form-stacked'));?>
			<fieldset>
				...
				<?php
					...
					echo $this->Form->input('link', array('div' => 'clearfix'));
