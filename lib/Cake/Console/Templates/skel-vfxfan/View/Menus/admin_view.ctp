...
<div class="row">
	<section class="admin-actions">
		...
		<ul class="action-buttons-list">
			...
			<li><?php echo $this->Form->postLink('Delete Menu', array('action' => 'admin_delete', $menu['Menu']['id']), array('class' => 'btn danger'), sprintf('Are you sure you want to delete # %s?', $menu['Menu']['id'])); ?> </li>
