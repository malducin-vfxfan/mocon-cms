		...
		<table class="bordered-table zebra-striped">
			...
			<tr>
				...
				<td>
					...
					<?php echo $this->Form->postLink('Delete', array('action' => 'admin_delete', $post['Post']['id']), array('class' => 'btn danger'), sprintf('Are you sure you want to delete # %s?', $post['Post']['id'])); ?>
				</td>
			</tr>
			<?php endforeach; ?>
		</table>
