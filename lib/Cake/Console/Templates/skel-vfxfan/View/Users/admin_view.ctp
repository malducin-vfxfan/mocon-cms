...
<section class="admin-actions">
	...
	<ul class="action-buttons-list">
		...
		<li><?php echo $this->Form->postLink('Delete User', array('action' => 'admin_delete', $user['User']['id']), array('class' => 'btn danger'), sprintf('Are you sure you want to delete # %s?', $user['User']['id'])); ?> </li>
		...
		<table class="bordered-table zebra-striped">
			...
			<tr>
				...
				<td>
					...
					<?php echo $this->Form->postLink('Delete', array('controller' => 'posts', 'action' => 'admin_delete', $post['Post']['id']), array('class' => 'btn danger'), sprintf('Are you sure you want to delete # %s?', $post['Post']['id'])); ?>
				</td>
			</tr>
			<?php endforeach; ?>
		</table>
