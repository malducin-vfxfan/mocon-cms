 ...
 * @package       Mocon-CMS.View.Elements.AddThis
 */
...
<div class="addthis_toolbox addthis_default_style <?php if (Configure::read('AddThis.style_32')) echo 'addthis_32x32_style';?>"
	addthis:title="<?php echo Configure::read('AddThis.title'); ?>"
	addthis:url="<?php echo $this->Html->url(array('controller' => 'pages', 'action' => 'index'), true); ?>"
>
